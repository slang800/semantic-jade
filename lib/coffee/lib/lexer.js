(function() {
  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.stringToken = function() {
      ...
      switch (this.chunk.charAt(0)) {
        ...
        case '"':
          ...
          if (0 < string.indexOf('#{', 1) || 0 < string.indexOf('!{', 1)) {
    ...
    Lexer.prototype.heredocToken = function() {
      ...
      if (quote === '"' && (0 <= doc.indexOf('#{') || 0 <= doc.indexOf('!{'))) {
    ...
    Lexer.prototype.heregexToken = function(match) {
      ...
      if (0 > body.indexOf('#{' || 0 > body.indexOf('!{'))) {
    ...
    Lexer.prototype.interpolateString = function(str, options) {
      var expr, flag, heredoc, i, inner, interpolated, len, letter, nested, pi, regex, tag, tokens, value, _i, _len, _ref2, _ref3, _ref4;
      if (options == null) {
        options = {};
      }
      ...
      while (letter = str.charAt(i += 1)) {
        ...
        if ((letter === '#' || letter === '!') && str.charAt(i + 1) === '{' && (expr = this.balancedString(str.slice(i + 1), '}'))) {
          flag = letter;
        } else {
          continue;
        }
